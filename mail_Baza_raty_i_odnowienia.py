...
class MailingRaty:
    ...
    def iterate_funct(self):
        for _ in self.select_cells():
            ...
            server = smtplib.SMTP('s19.cyber-folks.pl', 587)
            server.starttls()
                         ...
                         <table cellpadding="0" cellspacing="0" width="600" class="w320">
                           <tr>
                             <td class="pull-left mobile-header-padding-left" style="vertical-align: middle;">
                               <a href="https://ubezpieczenia-magro.pl/" class="logo" style="color: #4d4d4d;">MAGRO</a>
                             </td>
...
class MailingOdn:
    ...
    def __init__(self, TEXT):
        self.text = TEXT
        # self.wb = load_workbook(filename="M:/Agent baza/2014 BAZA MAGRO.xlsm", read_only=True)
        self.wb = load_workbook(filename="/run/user/1000/gvfs/smb-share:server=js,share=e/Agent baza/"
